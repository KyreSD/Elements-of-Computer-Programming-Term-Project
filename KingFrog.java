...
public class KingFrog extends Monster  
{
    ...
    public KingFrog() {
        ...
        downAnimation = new GifImage("KingFrogDown.gif");
        leftAnimation = new GifImage("KingFrogLeft.gif");
        rightAnimation = new GifImage("KingFrogRight.gif");
        upAnimation = new GifImage("KingFrogUp.gif");
        attackAnimation = new GifImage("KingFrogAttack.gif");
